Shader "Unlit/BlinnPhong"
{
    Properties
    {
        ...
        _SpecularColor("Specular Color", Color) = (0.9,0.9,0.9,1)
         ...
         _Glossiness("Glossiness",  Range(0, 1)) = 32
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float NdotH = saturate(DotClamped(normal, halfVector));
                // Multiply _Glossiness by itself to allow artist to use smaller
                // glossiness values in the inspector.
                float specularIntensity = lightIntensity*pow(NdotH , _Glossiness * 100);
                ...
                diffuse *= 1- max(_SpecularColor.r, max(_SpecularColor.g, _SpecularColor.b));
                return (specular + diffuse + UNITY_LIGHTMODEL_AMBIENT) *col*_Color;
            }
            ENDCG
        }
